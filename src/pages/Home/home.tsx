...
export default Home => {
    ...
    <div className='Content'>
        ...
        <p className='p1'>Rick and Morty é uma série de animação norte-americana criada por Justin Roiland e Dan Harmon. A série estreou em 2013 no canal Adult Swim e rapidamente ganhou uma base de fãs apaixonada, tornando-se um fenômeno cultural.</p>
        <p className='p2'>
